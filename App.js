    ...
    render () {
        return(
            <View style={styles.container}>
                ...
                <View style={{ top: 80}}>
                    <TouchableOpacity onPress={() => this.initializeGame()} style={{alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#666666', width: 100, height: 25 }}>
                            <Text style={{fontSize: 15, fontWeight: '500' }}>New Game</Text>
                    </TouchableOpacity>
                </View>

                <View style={{top: 120}}>
                    <Text>Tic Tac Toe by DeveloperDanX</Text>
                </View>
